...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/21 13:39:27 by nmeintje          #+#    #+#             */
/*   Updated: 2025/03/27 11:03:07 by nmeintje         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap &ScavTrap::operator=(const ScavTrap &other)
{
	...
	std::cout << CYAN << "ScavTrap: Assignment constructor called"
		  << DEFAULT << std::endl;
...
void ScavTrap::attack(const std::string& target) 
{
	...
	{
		std::cout << GREEN << "ScavTrap " << _name << " has no ENERGY points and cannot attack!"
			  << DEFAULT << std::endl;
		guardGate();
	}
	else if (_hitPoints == 0)
	{
		std::cout << GREEN << "ScavTrap " << _name << " has no HIT points and cannot attack!"
			  << DEFAULT << std::endl;
		guardGate();
	}
}
