...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/24 16:38:42 by nmeintje          #+#    #+#             */
/*   Updated: 2025/03/27 11:16:52 by nmeintje         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::~ScavTrap()
{
	std::cout << MAGENTA << "ScavTrap: Destructor called! Say goodbye to " << _name 
		  << DEFAULT << std::endl;
}
...
void ScavTrap::attack(const std::string& target) 
{
	...
	{
		std::cout << RED << "Scavtrap " << _name << " lunges at " << target 
	...
	{
		std::cout << BLUE << "ScavTrap " << _name << " has no ENERGY points and cannot attack!"
			  << DEFAULT << std::endl;
		guardGate();
	}
	else if (_hitPoints == 0)
	{
		std::cout << BLUE << "ScavTrap " << _name << " has no HIT points and cannot attack!"
			  << DEFAULT << std::endl;
		guardGate();
	}
}
